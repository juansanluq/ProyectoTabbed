package com.example.zafiro13.tabbedactivity;
...
public class Principal extends AppCompatActivity {
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            if(pestañaNuevos)
            {
                textView.setText("Estas en la pestaña VEHICULOS NUEVOS");
            }
            if(pestañaOcasion)
            {
                textView.setText("Estas en la pestaña VEHICULOS OCASION");
            }
            if(pestañaExtras)
            {
                textView.setText("Estas en la pestaña EXTRAS");
            }
